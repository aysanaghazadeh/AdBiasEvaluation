...
class CustomeSD3(nn.Module):
    ...
    def forward(self, prompt):
        ...
        return self.pipeline(prompt=cultural_components, style_image=style_image, negative_style_image=negative_style_image, cultural_components=prompt, generator=generator).images[0]
